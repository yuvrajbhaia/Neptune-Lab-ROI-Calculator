  ...
  return [
    {
      ...
      description: "Loss from rejected trial batches due to color fading after stretching",
    ...
    {
      id: 2,
      title: "R&D on New Pigments",
      description: "Potential savings from testing cheaper pigment alternatives",
    ...
    },
    {
      ...
      description: "Production loss from creating small sample batches for customers",
    ...
    {
      id: 4,
      title: "Lab In-charge Experiments",
      description: "Loss from experimenting with new recipes and formulations",
    ...
    {
      id: 5,
      title: "Recycled Material Testing",
      description: "Potential savings from testing recycled material blends",
    ...
    {
      id: 6,
      title: "Peak Season Customer Trials",
      description: "Production loss from urgent customer trials during peak season",
